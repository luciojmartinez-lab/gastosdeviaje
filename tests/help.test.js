...
test('la ayuda identifica fecha y versión y contiene las tres partes principales', async () => {
  ...
  assert.match(html, /Última actualización:<\/strong> 26 de julio de 2026/);
  assert.match(html, /Versión documentada:<\/strong> 700v218/);
...
test('todos los modales tienen ayuda contextual con un destino documentado', async () => {
  ...
  assert.equal(allDialogIds.length, 21);
  assert.equal(dialogIds.length, 19);
