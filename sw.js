...
const CACHE_NAME = 'gastosdeviaje-700v291-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v291',
  './timeline-import.js?v=700v291',
  './timeline-routing.js?v=700v291',
  './map-model.js?v=700v291',
  './app.bundle.js?v=700v291',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v291',
  './ticket-image-worker.js?v=700v291',
  './ticket-image-processing.js?v=700v291',
  './image-location.js?v=700v291',
  './share-pdf.js?v=700v291',
  './ayuda.html',
