const CACHE_NAME = 'gastosdeviaje-700v167-offline-start';
...
const APP_SHELL_REQUIRED = [
  './',
  './index.html',
  './styles.css?v=700v167',
  './map-model.js?v=700v167',
  './app.bundle.js?v=700v167',
  './vendor/maplibre/maplibre-gl.css?v=5.24.0',
  './vendor/maplibre/maplibre-gl.js?v=5.24.0',
  './manifest.webmanifest?v=700v167',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v167',
  './image-location.js?v=700v167',
  './ayuda.html',
