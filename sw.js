...
const CACHE_NAME = 'gastosdeviaje-700v270-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v270',
  './timeline-import.js?v=700v270',
  './map-model.js?v=700v270',
  './app.bundle.js?v=700v270',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v270',
  './ticket-image-worker.js?v=700v270',
  './ticket-image-processing.js?v=700v270',
  './image-location.js?v=700v270',
  './share-pdf.js?v=700v270',
  './ayuda.html',
