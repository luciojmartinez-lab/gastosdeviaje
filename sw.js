...
const CACHE_NAME = 'gastosdeviaje-700v266-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v266',
  './timeline-import.js?v=700v266',
  './map-model.js?v=700v266',
  './app.bundle.js?v=700v266',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v266',
  './ticket-image-worker.js?v=700v266',
  './ticket-image-processing.js?v=700v266',
  './image-location.js?v=700v266',
  './share-pdf.js?v=700v266',
  './ayuda.html',
