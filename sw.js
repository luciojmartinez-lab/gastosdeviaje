...
const CACHE_NAME = 'gastosdeviaje-700v257-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v257',
  './timeline-import.js?v=700v257',
  './map-model.js?v=700v257',
  './app.bundle.js?v=700v257',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v257',
  './ticket-image-worker.js?v=700v257',
  './ticket-image-processing.js?v=700v257',
  './image-location.js?v=700v257',
  './share-pdf.js?v=700v257',
  './ayuda.html',
