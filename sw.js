...
const CACHE_NAME = 'gastosdeviaje-700v283-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v283',
  './timeline-import.js?v=700v283',
  './timeline-routing.js?v=700v283',
  './map-model.js?v=700v283',
  './app.bundle.js?v=700v283',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v283',
  './ticket-image-worker.js?v=700v283',
  './ticket-image-processing.js?v=700v283',
  './image-location.js?v=700v283',
  './share-pdf.js?v=700v283',
  './ayuda.html',
