const APP_VERSION = '700v190';
const CACHE_NAME = 'gastosdeviaje-700v190-offline-start';
...
const APP_SHELL_REQUIRED = [
  './',
  './index.html',
  './styles.css?v=700v190',
  './map-model.js?v=700v190',
  './app.bundle.js?v=700v190',
  './vendor/maplibre/maplibre-gl.css?v=5.24.0',
  './vendor/maplibre/maplibre-gl.js?v=5.24.0',
  './manifest.webmanifest?v=700v190',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v190',
  './image-location.js?v=700v190',
  './share-pdf.js?v=700v190',
  './ayuda.html',
