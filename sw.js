...
const CACHE_NAME = 'gastosdeviaje-700v307-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v307',
  './timeline-import.js?v=700v307',
  './gpx-import.js?v=700v307',
  './timeline-routing.js?v=700v307',
  './map-model.js?v=700v307',
  './app.bundle.js?v=700v307',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v307',
  './ticket-image-worker.js?v=700v307',
  './ticket-image-processing.js?v=700v307',
  './image-location.js?v=700v307',
  './share-pdf.js?v=700v307',
  './ayuda.html',
