...
const CACHE_NAME = 'gastosdeviaje-700v298-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v298',
  './timeline-import.js?v=700v298',
  './gpx-import.js?v=700v298',
  './timeline-routing.js?v=700v298',
  './map-model.js?v=700v298',
  './app.bundle.js?v=700v298',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v298',
  './ticket-image-worker.js?v=700v298',
  './ticket-image-processing.js?v=700v298',
  './image-location.js?v=700v298',
  './share-pdf.js?v=700v298',
  './ayuda.html',
