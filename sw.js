...
const CACHE_NAME = 'gastosdeviaje-700v254-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v254',
  './timeline-import.js?v=700v254',
  './map-model.js?v=700v254',
  './app.bundle.js?v=700v254',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v254',
  './ticket-image-worker.js?v=700v254',
  './ticket-image-processing.js?v=700v254',
  './image-location.js?v=700v254',
  './share-pdf.js?v=700v254',
  './ayuda.html',
