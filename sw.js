...
const CACHE_NAME = 'gastosdeviaje-700v302-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v302',
  './timeline-import.js?v=700v302',
  './gpx-import.js?v=700v302',
  './timeline-routing.js?v=700v302',
  './map-model.js?v=700v302',
  './app.bundle.js?v=700v302',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v302',
  './ticket-image-worker.js?v=700v302',
  './ticket-image-processing.js?v=700v302',
  './image-location.js?v=700v302',
  './share-pdf.js?v=700v302',
  './ayuda.html',
