const APP_VERSION = '700v271';
const CACHE_NAME = 'gastosdeviaje-700v271-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v271',
  './timeline-import.js?v=700v271',
  './map-model.js?v=700v271',
  './app.bundle.js?v=700v271',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v271',
  './ticket-image-worker.js?v=700v271',
  './ticket-image-processing.js?v=700v271',
  './image-location.js?v=700v271',
  './share-pdf.js?v=700v271',
  './ayuda.html',
