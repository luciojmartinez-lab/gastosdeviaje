...
const CACHE_NAME = 'gastosdeviaje-700v285-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v285',
  './timeline-import.js?v=700v285',
  './timeline-routing.js?v=700v285',
  './map-model.js?v=700v285',
  './app.bundle.js?v=700v285',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v285',
  './ticket-image-worker.js?v=700v285',
  './ticket-image-processing.js?v=700v285',
  './image-location.js?v=700v285',
  './share-pdf.js?v=700v285',
  './ayuda.html',
