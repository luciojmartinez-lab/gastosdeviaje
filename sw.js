...
const CACHE_NAME = 'gastosdeviaje-700v252-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v252',
  './timeline-import.js?v=700v252',
  './map-model.js?v=700v252',
  './app.bundle.js?v=700v252',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v252',
  './ticket-image-worker.js?v=700v252',
  './ticket-image-processing.js?v=700v252',
  './image-location.js?v=700v252',
  './share-pdf.js?v=700v252',
  './ayuda.html',
