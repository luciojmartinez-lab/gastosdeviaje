...
const CACHE_NAME = 'gastosdeviaje-700v313-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v313',
  './timeline-import.js?v=700v313',
  './gpx-import.js?v=700v313',
  './timeline-routing.js?v=700v313',
  './map-model.js?v=700v313',
  './app.bundle.js?v=700v313',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v313',
  './ticket-image-worker.js?v=700v313',
  './ticket-image-processing.js?v=700v313',
  './image-location.js?v=700v313',
  './share-pdf.js?v=700v313',
  './ayuda.html',
