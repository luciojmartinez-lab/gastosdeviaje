...
const CACHE_NAME = 'gastosdeviaje-700v284-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v284',
  './timeline-import.js?v=700v284',
  './timeline-routing.js?v=700v284',
  './map-model.js?v=700v284',
  './app.bundle.js?v=700v284',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v284',
  './ticket-image-worker.js?v=700v284',
  './ticket-image-processing.js?v=700v284',
  './image-location.js?v=700v284',
  './share-pdf.js?v=700v284',
  './ayuda.html',
