...
const CACHE_NAME = 'gastosdeviaje-700v264-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v264',
  './timeline-import.js?v=700v264',
  './map-model.js?v=700v264',
  './app.bundle.js?v=700v264',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v264',
  './ticket-image-worker.js?v=700v264',
  './ticket-image-processing.js?v=700v264',
  './image-location.js?v=700v264',
  './share-pdf.js?v=700v264',
  './ayuda.html',
