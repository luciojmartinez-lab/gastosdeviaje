...
const CACHE_NAME = 'gastosdeviaje-700v239-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v239',
  './map-model.js?v=700v239',
  './app.bundle.js?v=700v239',
  './version.txt'
];
const APP_SHELL_REQUIRED = [
  ...
  './manifest.webmanifest?v=700v239',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v239',
  './ticket-image-worker.js?v=700v239',
  './ticket-image-processing.js?v=700v239',
  './image-location.js?v=700v239',
  './share-pdf.js?v=700v239',
  './ayuda.html',
