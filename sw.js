...
const CACHE_NAME = 'gastosdeviaje-700v323-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v323',
  './timeline-import.js?v=700v323',
  './gpx-import.js?v=700v323',
  './timeline-routing.js?v=700v323',
  './map-model.js?v=700v323',
  './app.bundle.js?v=700v323',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v323',
  './ticket-image-worker.js?v=700v323',
  './ticket-image-processing.js?v=700v323',
  './image-location.js?v=700v323',
  './share-pdf.js?v=700v323',
  './ayuda.html',
