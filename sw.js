...
const CACHE_NAME = 'gastosdeviaje-700v308-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v308',
  './timeline-import.js?v=700v308',
  './gpx-import.js?v=700v308',
  './timeline-routing.js?v=700v308',
  './map-model.js?v=700v308',
  './app.bundle.js?v=700v308',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v308',
  './ticket-image-worker.js?v=700v308',
  './ticket-image-processing.js?v=700v308',
  './image-location.js?v=700v308',
  './share-pdf.js?v=700v308',
  './ayuda.html',
