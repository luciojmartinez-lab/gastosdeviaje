...
const CACHE_NAME = 'gastosdeviaje-700v280-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v280',
  './timeline-import.js?v=700v280',
  './timeline-routing.js?v=700v280',
  './map-model.js?v=700v280',
  './app.bundle.js?v=700v280',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v280',
  './ticket-image-worker.js?v=700v280',
  './ticket-image-processing.js?v=700v280',
  './image-location.js?v=700v280',
  './share-pdf.js?v=700v280',
  './ayuda.html',
