...
const CACHE_NAME = 'gastosdeviaje-700v261-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v261',
  './timeline-import.js?v=700v261',
  './map-model.js?v=700v261',
  './app.bundle.js?v=700v261',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v261',
  './ticket-image-worker.js?v=700v261',
  './ticket-image-processing.js?v=700v261',
  './image-location.js?v=700v261',
  './share-pdf.js?v=700v261',
  './ayuda.html',
