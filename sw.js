...
const CACHE_NAME = 'gastosdeviaje-700v282-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v282',
  './timeline-import.js?v=700v282',
  './timeline-routing.js?v=700v282',
  './map-model.js?v=700v282',
  './app.bundle.js?v=700v282',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v282',
  './ticket-image-worker.js?v=700v282',
  './ticket-image-processing.js?v=700v282',
  './image-location.js?v=700v282',
  './share-pdf.js?v=700v282',
  './ayuda.html',
