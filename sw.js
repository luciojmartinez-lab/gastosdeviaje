...
const CACHE_NAME = 'gastosdeviaje-700v319-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v319',
  './timeline-import.js?v=700v319',
  './gpx-import.js?v=700v319',
  './timeline-routing.js?v=700v319',
  './map-model.js?v=700v319',
  './app.bundle.js?v=700v319',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v319',
  './ticket-image-worker.js?v=700v319',
  './ticket-image-processing.js?v=700v319',
  './image-location.js?v=700v319',
  './share-pdf.js?v=700v319',
  './ayuda.html',
