...
const CACHE_NAME = 'gastosdeviaje-700v295-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v295',
  './timeline-import.js?v=700v295',
  './gpx-import.js?v=700v295',
  './timeline-routing.js?v=700v295',
  './map-model.js?v=700v295',
  './app.bundle.js?v=700v295',
  './version.txt'
];
const APP_SHELL_REQUIRED = [
  ...
  './timeline-import.js?v=700v295',
  './gpx-import.js?v=700v295',
  './timeline-import-worker.js?v=700v295',
  './timeline-routing.js?v=700v295',
  './map-model.js?v=700v295',
  './app.bundle.js?v=700v295',
  './vendor/maplibre/maplibre-gl.css?v=5.24.0',
  './vendor/maplibre/maplibre-gl.js?v=5.24.0',
  './manifest.webmanifest?v=700v295',
  './version.txt',
  './assets/bitacora-splash.png',
  './assets/bitacora-splash-mobile.png',
  './assets/loading-train.png',
  './assets/map-train-side.webp'
];
const APP_SHELL_OPTIONAL = [
  './assets/app-icon-192.png',
  './assets/app-icon-512.png',
  './ticket-ocr.js?v=700v295',
  './ticket-image-worker.js?v=700v295',
  './ticket-image-processing.js?v=700v295',
  './image-location.js?v=700v295',
  './share-pdf.js?v=700v295',
  './ayuda.html',
  './assets/help/01-viajes.png',
  './assets/help/02-configuracion.png',
  './assets/help/03-alta-gasto.png',
  './assets/help/04-tabla-gastos.png',
  './assets/help/05-blog.png',
  './assets/help/06-alta-blog.png',
  './assets/help/06-punto-blog.png',
  './assets/help/07-mapa.png',
  './assets/help/08-resumen.png',
  './output/pdf/ayuda-cuaderno-bitacora.pdf',
...
async function cachedNavigationResponse(request) {
  ...
  if (requestUrl.searchParams.has('v')) {
    try {
      const fresh = await updateNavigationCache(request);
