const APP_VERSION = '700v279';
const CACHE_NAME = 'gastosdeviaje-700v279-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v279',
  './timeline-import.js?v=700v279',
  './timeline-routing.js?v=700v279',
  './map-model.js?v=700v279',
  './app.bundle.js?v=700v279',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v279',
  './ticket-image-worker.js?v=700v279',
  './ticket-image-processing.js?v=700v279',
  './image-location.js?v=700v279',
  './share-pdf.js?v=700v279',
  './ayuda.html',
