...
const CACHE_NAME = 'gastosdeviaje-700v281-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v281',
  './timeline-import.js?v=700v281',
  './timeline-routing.js?v=700v281',
  './map-model.js?v=700v281',
  './app.bundle.js?v=700v281',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v281',
  './ticket-image-worker.js?v=700v281',
  './ticket-image-processing.js?v=700v281',
  './image-location.js?v=700v281',
  './share-pdf.js?v=700v281',
  './ayuda.html',
