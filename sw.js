const CACHE_NAME = 'gastosdeviaje-700v129';
...
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=700v129',
  './map-model.js?v=700v129',
  './app.bundle.js?v=700v129',
  './vendor/maplibre/maplibre-gl.css?v=5.24.0',
  './vendor/maplibre/maplibre-gl.js?v=5.24.0',
  './ticket-ocr.js?v=700v129',
  './image-location.js?v=700v129',
  './ayuda.html',
