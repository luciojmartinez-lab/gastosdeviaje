...
const CACHE_NAME = 'gastosdeviaje-700v230-offline-start';
...
const APP_SHELL_REQUIRED = [
  './',
  './index.html',
  './styles.css?v=700v230',
  './map-model.js?v=700v230',
  './app.bundle.js?v=700v230',
  './vendor/maplibre/maplibre-gl.css?v=5.24.0',
  './vendor/maplibre/maplibre-gl.js?v=5.24.0',
  './manifest.webmanifest?v=700v230',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v230',
  './ticket-image-worker.js?v=700v230',
  './ticket-image-processing.js?v=700v230',
  './image-location.js?v=700v230',
  './share-pdf.js?v=700v230',
  './ayuda.html',
