...
const CACHE_NAME = 'gastosdeviaje-700v310-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v310',
  './timeline-import.js?v=700v310',
  './gpx-import.js?v=700v310',
  './timeline-routing.js?v=700v310',
  './map-model.js?v=700v310',
  './app.bundle.js?v=700v310',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v310',
  './ticket-image-worker.js?v=700v310',
  './ticket-image-processing.js?v=700v310',
  './image-location.js?v=700v310',
  './share-pdf.js?v=700v310',
  './ayuda.html',
