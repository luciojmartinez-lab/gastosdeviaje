...
const CACHE_NAME = 'gastosdeviaje-700v318-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v318',
  './timeline-import.js?v=700v318',
  './gpx-import.js?v=700v318',
  './timeline-routing.js?v=700v318',
  './map-model.js?v=700v318',
  './app.bundle.js?v=700v318',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v318',
  './ticket-image-worker.js?v=700v318',
  './ticket-image-processing.js?v=700v318',
  './image-location.js?v=700v318',
  './share-pdf.js?v=700v318',
  './ayuda.html',
