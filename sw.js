...
const CACHE_NAME = 'gastosdeviaje-700v269-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v269',
  './timeline-import.js?v=700v269',
  './map-model.js?v=700v269',
  './app.bundle.js?v=700v269',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v269',
  './ticket-image-worker.js?v=700v269',
  './ticket-image-processing.js?v=700v269',
  './image-location.js?v=700v269',
  './share-pdf.js?v=700v269',
  './ayuda.html',
