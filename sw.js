...
const CACHE_NAME = 'gastosdeviaje-700v296-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v296',
  './timeline-import.js?v=700v296',
  './gpx-import.js?v=700v296',
  './timeline-routing.js?v=700v296',
  './map-model.js?v=700v296',
  './app.bundle.js?v=700v296',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v296',
  './ticket-image-worker.js?v=700v296',
  './ticket-image-processing.js?v=700v296',
  './image-location.js?v=700v296',
  './share-pdf.js?v=700v296',
  './ayuda.html',
