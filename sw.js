...
const CACHE_NAME = 'gastosdeviaje-700v251-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v251',
  './timeline-import.js?v=700v251',
  './map-model.js?v=700v251',
  './app.bundle.js?v=700v251',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v251',
  './ticket-image-worker.js?v=700v251',
  './ticket-image-processing.js?v=700v251',
  './image-location.js?v=700v251',
  './share-pdf.js?v=700v251',
  './ayuda.html',
