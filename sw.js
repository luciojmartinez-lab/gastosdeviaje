...
const CACHE_NAME = 'gastosdeviaje-700v262-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v262',
  './timeline-import.js?v=700v262',
  './map-model.js?v=700v262',
  './app.bundle.js?v=700v262',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v262',
  './ticket-image-worker.js?v=700v262',
  './ticket-image-processing.js?v=700v262',
  './image-location.js?v=700v262',
  './share-pdf.js?v=700v262',
  './ayuda.html',
