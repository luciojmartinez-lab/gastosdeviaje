...
const CACHE_NAME = 'gastosdeviaje-700v288-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v288',
  './timeline-import.js?v=700v288',
  './timeline-routing.js?v=700v288',
  './map-model.js?v=700v288',
  './app.bundle.js?v=700v288',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v288',
  './ticket-image-worker.js?v=700v288',
  './ticket-image-processing.js?v=700v288',
  './image-location.js?v=700v288',
  './share-pdf.js?v=700v288',
  './ayuda.html',
