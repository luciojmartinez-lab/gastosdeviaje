...
const CACHE_NAME = 'gastosdeviaje-700v268-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v268',
  './timeline-import.js?v=700v268',
  './map-model.js?v=700v268',
  './app.bundle.js?v=700v268',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v268',
  './ticket-image-worker.js?v=700v268',
  './ticket-image-processing.js?v=700v268',
  './image-location.js?v=700v268',
  './share-pdf.js?v=700v268',
  './ayuda.html',
