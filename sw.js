...
const CACHE_NAME = 'gastosdeviaje-700v278-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v278',
  './timeline-import.js?v=700v278',
  './timeline-routing.js?v=700v278',
  './map-model.js?v=700v278',
  './app.bundle.js?v=700v278',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v278',
  './ticket-image-worker.js?v=700v278',
  './ticket-image-processing.js?v=700v278',
  './image-location.js?v=700v278',
  './share-pdf.js?v=700v278',
  './ayuda.html',
