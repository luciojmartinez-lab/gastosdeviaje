...
const CACHE_NAME = 'gastosdeviaje-700v303-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v303',
  './timeline-import.js?v=700v303',
  './gpx-import.js?v=700v303',
  './timeline-routing.js?v=700v303',
  './map-model.js?v=700v303',
  './app.bundle.js?v=700v303',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v303',
  './ticket-image-worker.js?v=700v303',
  './ticket-image-processing.js?v=700v303',
  './image-location.js?v=700v303',
  './share-pdf.js?v=700v303',
  './ayuda.html',
