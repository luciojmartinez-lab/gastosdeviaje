...
const CACHE_NAME = 'gastosdeviaje-700v272-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v272',
  './timeline-import.js?v=700v272',
  './timeline-routing.js?v=700v272',
  './map-model.js?v=700v272',
  './app.bundle.js?v=700v272',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v272',
  './ticket-image-worker.js?v=700v272',
  './ticket-image-processing.js?v=700v272',
  './image-location.js?v=700v272',
  './share-pdf.js?v=700v272',
  './ayuda.html',
