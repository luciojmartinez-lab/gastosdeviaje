...
const CACHE_NAME = 'gastosdeviaje-700v253-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v253',
  './timeline-import.js?v=700v253',
  './map-model.js?v=700v253',
  './app.bundle.js?v=700v253',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v253',
  './ticket-image-worker.js?v=700v253',
  './ticket-image-processing.js?v=700v253',
  './image-location.js?v=700v253',
  './share-pdf.js?v=700v253',
  './ayuda.html',
