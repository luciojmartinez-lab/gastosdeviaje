...
const CACHE_NAME = 'gastosdeviaje-700v275-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v275',
  './timeline-import.js?v=700v275',
  './timeline-routing.js?v=700v275',
  './map-model.js?v=700v275',
  './app.bundle.js?v=700v275',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v275',
  './ticket-image-worker.js?v=700v275',
  './ticket-image-processing.js?v=700v275',
  './image-location.js?v=700v275',
  './share-pdf.js?v=700v275',
  './ayuda.html',
