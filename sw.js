...
const CACHE_NAME = 'gastosdeviaje-700v232-offline-start';
...
const APP_SHELL_REQUIRED = [
  './',
  './index.html',
  './styles.css?v=700v232',
  './map-model.js?v=700v232',
  './app.bundle.js?v=700v232',
  './vendor/maplibre/maplibre-gl.css?v=5.24.0',
  './vendor/maplibre/maplibre-gl.js?v=5.24.0',
  './manifest.webmanifest?v=700v232',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v232',
  './ticket-image-worker.js?v=700v232',
  './ticket-image-processing.js?v=700v232',
  './image-location.js?v=700v232',
  './share-pdf.js?v=700v232',
  './ayuda.html',
