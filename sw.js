...
const CACHE_NAME = 'gastosdeviaje-700v309-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v309',
  './timeline-import.js?v=700v309',
  './gpx-import.js?v=700v309',
  './timeline-routing.js?v=700v309',
  './map-model.js?v=700v309',
  './app.bundle.js?v=700v309',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v309',
  './ticket-image-worker.js?v=700v309',
  './ticket-image-processing.js?v=700v309',
  './image-location.js?v=700v309',
  './share-pdf.js?v=700v309',
  './ayuda.html',
