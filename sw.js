...
const CACHE_NAME = 'gastosdeviaje-700v311-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v311',
  './timeline-import.js?v=700v311',
  './gpx-import.js?v=700v311',
  './timeline-routing.js?v=700v311',
  './map-model.js?v=700v311',
  './app.bundle.js?v=700v311',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v311',
  './ticket-image-worker.js?v=700v311',
  './ticket-image-processing.js?v=700v311',
  './image-location.js?v=700v311',
  './share-pdf.js?v=700v311',
  './ayuda.html',
