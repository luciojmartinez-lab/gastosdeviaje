...
const CACHE_NAME = 'gastosdeviaje-700v322-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v322',
  './timeline-import.js?v=700v322',
  './gpx-import.js?v=700v322',
  './timeline-routing.js?v=700v322',
  './map-model.js?v=700v322',
  './app.bundle.js?v=700v322',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v322',
  './ticket-image-worker.js?v=700v322',
  './ticket-image-processing.js?v=700v322',
  './image-location.js?v=700v322',
  './share-pdf.js?v=700v322',
  './ayuda.html',
