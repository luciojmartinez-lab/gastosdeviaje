...
const CACHE_NAME = 'gastosdeviaje-700v255-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v255',
  './timeline-import.js?v=700v255',
  './map-model.js?v=700v255',
  './app.bundle.js?v=700v255',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v255',
  './ticket-image-worker.js?v=700v255',
  './ticket-image-processing.js?v=700v255',
  './image-location.js?v=700v255',
  './share-pdf.js?v=700v255',
  './ayuda.html',
