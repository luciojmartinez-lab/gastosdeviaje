...
const CACHE_NAME = 'gastosdeviaje-700v300-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v300',
  './timeline-import.js?v=700v300',
  './gpx-import.js?v=700v300',
  './timeline-routing.js?v=700v300',
  './map-model.js?v=700v300',
  './app.bundle.js?v=700v300',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v300',
  './ticket-image-worker.js?v=700v300',
  './ticket-image-processing.js?v=700v300',
  './image-location.js?v=700v300',
  './share-pdf.js?v=700v300',
  './ayuda.html',
