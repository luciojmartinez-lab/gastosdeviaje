const APP_VERSION = '700v248';
const CACHE_NAME = 'gastosdeviaje-700v248-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v248',
  './map-model.js?v=700v248',
  './app.bundle.js?v=700v248',
  './version.txt'
];
const APP_SHELL_REQUIRED = [
  ...
  './manifest.webmanifest?v=700v248',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v248',
  './ticket-image-worker.js?v=700v248',
  './ticket-image-processing.js?v=700v248',
  './image-location.js?v=700v248',
  './share-pdf.js?v=700v248',
  './ayuda.html',
