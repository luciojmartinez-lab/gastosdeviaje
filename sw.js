...
const CACHE_NAME = 'gastosdeviaje-700v274-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v274',
  './timeline-import.js?v=700v274',
  './timeline-routing.js?v=700v274',
  './map-model.js?v=700v274',
  './app.bundle.js?v=700v274',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v274',
  './ticket-image-worker.js?v=700v274',
  './ticket-image-processing.js?v=700v274',
  './image-location.js?v=700v274',
  './share-pdf.js?v=700v274',
  './ayuda.html',
