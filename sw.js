...
const CACHE_NAME = 'gastosdeviaje-700v320-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v320',
  './timeline-import.js?v=700v320',
  './gpx-import.js?v=700v320',
  './timeline-routing.js?v=700v320',
  './map-model.js?v=700v320',
  './app.bundle.js?v=700v320',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v320',
  './ticket-image-worker.js?v=700v320',
  './ticket-image-processing.js?v=700v320',
  './image-location.js?v=700v320',
  './share-pdf.js?v=700v320',
  './ayuda.html',
