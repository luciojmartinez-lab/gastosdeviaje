...
const CACHE_NAME = 'gastosdeviaje-700v265-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v265',
  './timeline-import.js?v=700v265',
  './map-model.js?v=700v265',
  './app.bundle.js?v=700v265',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v265',
  './ticket-image-worker.js?v=700v265',
  './ticket-image-processing.js?v=700v265',
  './image-location.js?v=700v265',
  './share-pdf.js?v=700v265',
  './ayuda.html',
