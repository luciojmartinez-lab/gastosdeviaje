...
const CACHE_NAME = 'gastosdeviaje-700v245-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v245',
  './map-model.js?v=700v245',
  './app.bundle.js?v=700v245',
  './version.txt'
];
const APP_SHELL_REQUIRED = [
  ...
  './manifest.webmanifest?v=700v245',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v245',
  './ticket-image-worker.js?v=700v245',
  './ticket-image-processing.js?v=700v245',
  './image-location.js?v=700v245',
  './share-pdf.js?v=700v245',
  './ayuda.html',
