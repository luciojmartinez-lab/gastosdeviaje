...
const CACHE_NAME = 'gastosdeviaje-700v263-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v263',
  './timeline-import.js?v=700v263',
  './map-model.js?v=700v263',
  './app.bundle.js?v=700v263',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v263',
  './ticket-image-worker.js?v=700v263',
  './ticket-image-processing.js?v=700v263',
  './image-location.js?v=700v263',
  './share-pdf.js?v=700v263',
  './ayuda.html',
