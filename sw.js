...
const CACHE_NAME = 'gastosdeviaje-700v273-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v273',
  './timeline-import.js?v=700v273',
  './timeline-routing.js?v=700v273',
  './map-model.js?v=700v273',
  './app.bundle.js?v=700v273',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v273',
  './ticket-image-worker.js?v=700v273',
  './ticket-image-processing.js?v=700v273',
  './image-location.js?v=700v273',
  './share-pdf.js?v=700v273',
  './ayuda.html',
