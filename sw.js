...
const CACHE_NAME = 'gastosdeviaje-700v256-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v256',
  './timeline-import.js?v=700v256',
  './map-model.js?v=700v256',
  './app.bundle.js?v=700v256',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v256',
  './ticket-image-worker.js?v=700v256',
  './ticket-image-processing.js?v=700v256',
  './image-location.js?v=700v256',
  './share-pdf.js?v=700v256',
  './ayuda.html',
