...
const CACHE_NAME = 'gastosdeviaje-700v314-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v314',
  './timeline-import.js?v=700v314',
  './gpx-import.js?v=700v314',
  './timeline-routing.js?v=700v314',
  './map-model.js?v=700v314',
  './app.bundle.js?v=700v314',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v314',
  './ticket-image-worker.js?v=700v314',
  './ticket-image-processing.js?v=700v314',
  './image-location.js?v=700v314',
  './share-pdf.js?v=700v314',
  './ayuda.html',
