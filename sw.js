...
const CACHE_NAME = 'gastosdeviaje-700v306-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v306',
  './timeline-import.js?v=700v306',
  './gpx-import.js?v=700v306',
  './timeline-routing.js?v=700v306',
  './map-model.js?v=700v306',
  './app.bundle.js?v=700v306',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v306',
  './ticket-image-worker.js?v=700v306',
  './ticket-image-processing.js?v=700v306',
  './image-location.js?v=700v306',
  './share-pdf.js?v=700v306',
  './ayuda.html',
