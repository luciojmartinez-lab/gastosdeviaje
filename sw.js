const APP_VERSION = '700v242';
const CACHE_NAME = 'gastosdeviaje-700v242-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v242',
  './map-model.js?v=700v242',
  './app.bundle.js?v=700v242',
  './version.txt'
];
const APP_SHELL_REQUIRED = [
  ...
  './manifest.webmanifest?v=700v242',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v242',
  './ticket-image-worker.js?v=700v242',
  './ticket-image-processing.js?v=700v242',
  './image-location.js?v=700v242',
  './share-pdf.js?v=700v242',
  './ayuda.html',
