...
const CACHE_NAME = 'gastosdeviaje-700v244-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v244',
  './map-model.js?v=700v244',
  './app.bundle.js?v=700v244',
  './version.txt'
];
const APP_SHELL_REQUIRED = [
  ...
  './manifest.webmanifest?v=700v244',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v244',
  './ticket-image-worker.js?v=700v244',
  './ticket-image-processing.js?v=700v244',
  './image-location.js?v=700v244',
  './share-pdf.js?v=700v244',
  './ayuda.html',
