...
const CACHE_NAME = 'gastosdeviaje-700v321-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v321',
  './timeline-import.js?v=700v321',
  './gpx-import.js?v=700v321',
  './timeline-routing.js?v=700v321',
  './map-model.js?v=700v321',
  './app.bundle.js?v=700v321',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v321',
  './ticket-image-worker.js?v=700v321',
  './ticket-image-processing.js?v=700v321',
  './image-location.js?v=700v321',
  './share-pdf.js?v=700v321',
  './ayuda.html',
