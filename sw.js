...
const CACHE_NAME = 'gastosdeviaje-700v305-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v305',
  './timeline-import.js?v=700v305',
  './gpx-import.js?v=700v305',
  './timeline-routing.js?v=700v305',
  './map-model.js?v=700v305',
  './app.bundle.js?v=700v305',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v305',
  './ticket-image-worker.js?v=700v305',
  './ticket-image-processing.js?v=700v305',
  './image-location.js?v=700v305',
  './share-pdf.js?v=700v305',
  './ayuda.html',
