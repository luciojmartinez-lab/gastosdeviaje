...
const CACHE_NAME = 'gastosdeviaje-700v217-offline-start';
...
const APP_SHELL_REQUIRED = [
  './',
  './index.html',
  './styles.css?v=700v217',
  './map-model.js?v=700v217',
  './app.bundle.js?v=700v217',
  './vendor/maplibre/maplibre-gl.css?v=5.24.0',
  './vendor/maplibre/maplibre-gl.js?v=5.24.0',
  './manifest.webmanifest?v=700v217',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v217',
  './ticket-image-worker.js?v=700v217',
  './ticket-image-processing.js?v=700v217',
  './image-location.js?v=700v217',
  './share-pdf.js?v=700v217',
  './ayuda.html',
