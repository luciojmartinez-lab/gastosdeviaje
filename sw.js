...
const CACHE_NAME = 'gastosdeviaje-700v312-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v312',
  './timeline-import.js?v=700v312',
  './gpx-import.js?v=700v312',
  './timeline-routing.js?v=700v312',
  './map-model.js?v=700v312',
  './app.bundle.js?v=700v312',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v312',
  './ticket-image-worker.js?v=700v312',
  './ticket-image-processing.js?v=700v312',
  './image-location.js?v=700v312',
  './share-pdf.js?v=700v312',
  './ayuda.html',
