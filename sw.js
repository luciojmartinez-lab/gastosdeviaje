...
const CACHE_NAME = 'gastosdeviaje-700v247-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v247',
  './map-model.js?v=700v247',
  './app.bundle.js?v=700v247',
  './version.txt'
];
const APP_SHELL_REQUIRED = [
  ...
  './manifest.webmanifest?v=700v247',
  './version.txt',
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v247',
  './ticket-image-worker.js?v=700v247',
  './ticket-image-processing.js?v=700v247',
  './image-location.js?v=700v247',
  './share-pdf.js?v=700v247',
  './ayuda.html',
