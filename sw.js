...
const CACHE_NAME = 'gastosdeviaje-700v315-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v315',
  './timeline-import.js?v=700v315',
  './gpx-import.js?v=700v315',
  './timeline-routing.js?v=700v315',
  './map-model.js?v=700v315',
  './app.bundle.js?v=700v315',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v315',
  './ticket-image-worker.js?v=700v315',
  './ticket-image-processing.js?v=700v315',
  './image-location.js?v=700v315',
  './share-pdf.js?v=700v315',
  './ayuda.html',
