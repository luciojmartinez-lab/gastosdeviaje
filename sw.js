...
const CACHE_NAME = 'gastosdeviaje-700v297-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v297',
  './timeline-import.js?v=700v297',
  './gpx-import.js?v=700v297',
  './timeline-routing.js?v=700v297',
  './map-model.js?v=700v297',
  './app.bundle.js?v=700v297',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v297',
  './ticket-image-worker.js?v=700v297',
  './ticket-image-processing.js?v=700v297',
  './image-location.js?v=700v297',
  './share-pdf.js?v=700v297',
  './ayuda.html',
