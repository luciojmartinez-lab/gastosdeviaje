...
const CACHE_NAME = 'gastosdeviaje-700v290-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v290',
  './timeline-import.js?v=700v290',
  './timeline-routing.js?v=700v290',
  './map-model.js?v=700v290',
  './app.bundle.js?v=700v290',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v290',
  './ticket-image-worker.js?v=700v290',
  './ticket-image-processing.js?v=700v290',
  './image-location.js?v=700v290',
  './share-pdf.js?v=700v290',
  './ayuda.html',
