...
const CACHE_NAME = 'gastosdeviaje-700v304-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v304',
  './timeline-import.js?v=700v304',
  './gpx-import.js?v=700v304',
  './timeline-routing.js?v=700v304',
  './map-model.js?v=700v304',
  './app.bundle.js?v=700v304',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v304',
  './ticket-image-worker.js?v=700v304',
  './ticket-image-processing.js?v=700v304',
  './image-location.js?v=700v304',
  './share-pdf.js?v=700v304',
  './ayuda.html',
