...
const CACHE_NAME = 'gastosdeviaje-700v301-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v301',
  './timeline-import.js?v=700v301',
  './gpx-import.js?v=700v301',
  './timeline-routing.js?v=700v301',
  './map-model.js?v=700v301',
  './app.bundle.js?v=700v301',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v301',
  './ticket-image-worker.js?v=700v301',
  './ticket-image-processing.js?v=700v301',
  './image-location.js?v=700v301',
  './share-pdf.js?v=700v301',
  './ayuda.html',
