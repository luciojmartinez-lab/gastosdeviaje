...
const CACHE_NAME = 'gastosdeviaje-700v299-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v299',
  './timeline-import.js?v=700v299',
  './gpx-import.js?v=700v299',
  './timeline-routing.js?v=700v299',
  './map-model.js?v=700v299',
  './app.bundle.js?v=700v299',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v299',
  './ticket-image-worker.js?v=700v299',
  './ticket-image-processing.js?v=700v299',
  './image-location.js?v=700v299',
  './share-pdf.js?v=700v299',
  './ayuda.html',
