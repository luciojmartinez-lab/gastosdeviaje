...
const CACHE_NAME = 'gastosdeviaje-700v289-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v289',
  './timeline-import.js?v=700v289',
  './timeline-routing.js?v=700v289',
  './map-model.js?v=700v289',
  './app.bundle.js?v=700v289',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v289',
  './ticket-image-worker.js?v=700v289',
  './ticket-image-processing.js?v=700v289',
  './image-location.js?v=700v289',
  './share-pdf.js?v=700v289',
  './ayuda.html',
