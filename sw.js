...
const CACHE_NAME = 'gastosdeviaje-700v267-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v267',
  './timeline-import.js?v=700v267',
  './map-model.js?v=700v267',
  './app.bundle.js?v=700v267',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v267',
  './ticket-image-worker.js?v=700v267',
  './ticket-image-processing.js?v=700v267',
  './image-location.js?v=700v267',
  './share-pdf.js?v=700v267',
  './ayuda.html',
