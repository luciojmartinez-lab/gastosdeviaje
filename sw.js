...
const CACHE_NAME = 'gastosdeviaje-700v294-offline-start';
...
const APP_SHELL_CORE = [
  './index.html',
  './styles.css?v=700v294',
  './timeline-import.js?v=700v294',
  './gpx-import.js?v=700v294',
  './timeline-routing.js?v=700v294',
  './map-model.js?v=700v294',
  './app.bundle.js?v=700v294',
  './version.txt'
];
...
const APP_SHELL_OPTIONAL = [
  ...
  './ticket-ocr.js?v=700v294',
  './ticket-image-worker.js?v=700v294',
  './ticket-image-processing.js?v=700v294',
  './image-location.js?v=700v294',
  './share-pdf.js?v=700v294',
  './ayuda.html',
